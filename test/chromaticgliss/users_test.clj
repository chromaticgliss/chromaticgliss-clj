...
(deftest create-read-users
  ...
  (testing "Create with user level"
    (let [admin (users/create {:name "Jane Doe" :email "jane@ihearttractors.com" :password "foo" :level "admin"}) expected-level :chromaticgliss.models.users/admin]
