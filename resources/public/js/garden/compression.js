 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__13597){
var vec__13599 = p__13597;
var tag = cljs.core.nth.call(null,vec__13599,(0),null);
var re = cljs.core.nth.call(null,vec__13599,(1),null);
return ((function (vec__13599,tag,re){
return (function (s){
...
var len__7200__auto___13602 = arguments.length;
var i__7201__auto___13603 = (0);
while(true){
if((i__7201__auto___13603 < len__7200__auto___13602)){
args__7207__auto__.push((arguments[i__7201__auto___13603]));

var G__13604 = (i__7201__auto___13603 + (1));
i__7201__auto___13603 = G__13604;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__7208__auto__);
});
...
return p1__13600_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq13601){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13601));
});
/**
...
var map__13608 = temp__4423__auto__;
...
var tag = cljs.core.get.call(null,map__13608__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__13608__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__13608__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__13611 = cljs.core.subs.call(null,s1,size);
var G__13612 = [cljs.core.str(s2),cljs.core.str((function (){var G__13610 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__13610) {
case "l-brace":
return "}";
